...
2. Surface `key_mismatch`, `key_revoked`, and `another_session_may_be_running` to your own agent reasoning. They are advisory facts, not CLI-side locks: decide whether a recovery run is appropriate. Re-running Connect is the recovery path.
